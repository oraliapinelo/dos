<?php /* Smarty version Smarty-3.1.19, created on 2016-08-10 02:46:10
         compiled from "C:\xampp\htdocs\tienda\themes\theme593\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2737657aadbc26519b0-72040773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ee3d3301a9250d950a357cf7b72dcad497f05905' => 
    array (
      0 => 'C:\\xampp\\htdocs\\tienda\\themes\\theme593\\shopping-cart.tpl',
      1 => 1470729851,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2737657aadbc26519b0-72040773',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57aadbc2a12996_13264132',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57aadbc2a12996_13264132')) {function content_57aadbc2a12996_13264132($_smarty_tpl) {?>
...
<div class="order_delivery row">
	...
	<ul id="delivery_address" class="address  item span5">
		<li class="address_title titled_box"><h2><span><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</span></h2></li>
 ...
 <?php if ($_smarty_tpl->tpl_vars['delivery_state']->value) {?>(<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['delivery_state']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
	...
	<ul id="invoice_address" class="address alternate_item span5 titled_box">
		<li class="address_title"><h2><span><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
</span></h2></li>
...
?>
			<ul class="span4 titled_box address <?php if ($_smarty_tpl->tpl_vars['address']->last) {?>last_item<?php } elseif ($_smarty_tpl->tpl_vars['address']->first) {?>first_item<?php }?> <?php if ($_smarty_tpl->tpl_vars['address']->index%2) {?>alternate_item<?php } else { ?>item<?php }?>">
				<li class="address_title"><h2><span><?php echo $_smarty_tpl->tpl_vars['address']->value['object']['alias'];?>
</span></h2></li>
