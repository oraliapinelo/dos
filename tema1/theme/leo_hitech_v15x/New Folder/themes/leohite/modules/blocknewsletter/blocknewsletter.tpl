...
<div id="newsletter_block_left" class="block">
	<p>{l s='Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium  ' mod='blocknewsletter'}</p>
		...
		<form action="{$link->getPageLink('index')}" method="post">
			<p>
				...
				<input type="text" name="email" size="18" 
					...
					onblur="javascript:if(this.value=='')this.value='{l s='Enter your email' mod='blocknewsletter' js=1}';" 
					class="inputNew" />
				<!--<select name="action">
